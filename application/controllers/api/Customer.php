...
class Customer extends REST_Controller {
    ...
    */
	...
	{
        if(!empty($id)){
            $data = $this->db->get_where("customer", ['id' => $id])->row_array();
        }else{
    ...
    */
    public function index_post()
    {
        ...
        $this->response(['Customer created successfully.'], REST_Controller::HTTP_OK);
    } 
    ...
    */
    ...
    {
        $input = $this->put();
        $this->db->update('customer', $input, array('id'=>$id));
