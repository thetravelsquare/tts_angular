...
class Keys extends REST_Controller {
    ...
    */
    public function index_post()
    {
        ...
        $this->response(['Key created successfully.'], REST_Controller::HTTP_OK);
    } 
    ...
    */
    public function index_put($id)
    {
        ...
        $this->response(['Key updated successfully.'], REST_Controller::HTTP_OK);
    }
    ...
    */
    public function index_delete($id)
    {
        ...
        $this->response(['Key deleted successfully.'], REST_Controller::HTTP_OK);
    }
